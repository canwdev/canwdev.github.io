...
![image-20200706165450303](image-20200706165450303.webp)  
...
2. 在【控制台根节点】点击**文件** -> **添加/删除管理单元** -> 在左侧 **可用的管理单元** 找到 **证书** 添加到右侧，选择**计算机账户** -> 选择 **本地计算机** -> 完成 -> 确定  
   ...
   ![image-20200707094422495](image-20200707094422495.webp)  
  
   ![image-20200707094706700](image-20200707094706700.webp)  
  
   ![image-20200707094848365](image-20200707094848365.webp)  
  
3. 在 证书(本地计算机) -> 个人 -> 证书 -> 所有任务 -> 导入  
  
4. 右击导入的证书，在**所有任务**中选择**管理私钥**，添加 `NETWORK SERVICE` 组的权限  
  
   ![./image-20200707095408605](image-20200707095408605.webp)  
  
5. 双击刚添加的证书，将【详细信息-指纹】复制以便后续使用  
  
   ![image-20200707095600000](image-20200707095600000.webp)  
...
![image-20200707100310509](image-20200707100310509.webp)  
...
![image-20200706165133023](image-20200706165133023.webp)  
  
![image-20200706165253268](image-20200706165253268.webp)